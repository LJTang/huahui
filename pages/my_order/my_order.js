...
Page({
    ...
    onShow:function (){
        ...
        GMAPI.doSendMsg('user/order_list',{user_id:wx.getStorageSync('strWXID').strUserID,status:that.data.activeID,type:1,wx_open_id:wx.getStorageSync('strWXID').strWXOpenID},'POST',that.onMsgCallBack_Order);
    ...
    ***导航栏点击
    ...
    tabToggle: function (e) {
        ...
        GMAPI.doSendMsg('user/order_list',{user_id:wx.getStorageSync('strWXID').strUserID,status:parseInt(e.currentTarget.dataset.index),type:1,wx_open_id:wx.getStorageSync('strWXID').strWXOpenID},'POST',that.onMsgCallBack_Order);
    },
    nacTo:function(){
        wx.navigateTo({
            url: '/pages/vip/vip'
    ...
    jump_StayPlay:function(e){
        wx.navigateTo({
            url: '/pages/stay_play/stay_play?order_id='+e.currentTarget.dataset.id
